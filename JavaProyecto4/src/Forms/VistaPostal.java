 ...
 */
public class VistaPostal extends javax.swing.JFrame {

    /**
     * Creates new form VistaPostal
     */
    public VistaPostal() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int testResult = fc.showOpenDialog(VistaPostal.this);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        VistaPostal vistaPostal = new VistaPostal();
        vistaPostal.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaPostal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaPostal().setVisible(true);
            }
        });
    }
    ...
    void crearPostal(){
        try {
            ...
            if ("BIMP".equals(jComboBox3.getSelectedItem().toString())) {
                extensionPostal = "3";
            }
            ...
            System.out.println("\"C:\\Users\\Lester Trejos\\"
                    + "Documents\\RepoLenguajesProyecto1\\repolenguajesproyecto1"
                    + "\\Proyecto1Lenguajes\\cmake-build-debug\\"
                    + "Proyecto1Lenguajes.exe\""+" \""+ubicacionImagen+
                    "\" "+extensionPostal+" "+nombrePostal+" "+
                    textoArriba+" "+textAbajo+" "+tipoLetra+" "+tamannoLetra);
                       
            Process p=Runtime.getRuntime().exec ("\"C:\\Users\\Lester Trejos\\"
                    + "Documents\\RepoLenguajesProyecto1\\repolenguajesproyecto1"
                    + "\\Proyecto1Lenguajes\\cmake-build-debug\\"
                    + "Proyecto1Lenguajes.exe\""+" \""+ubicacionImagen+
                    "\" "+extensionPostal+" "+nombrePostal+" "+
